    ...
    function walk(current) {
        for (const entry of readdirSync(current, { withFileTypes: true })) {
            ...
            if (entry.isDirectory()) {
                ...
                // Skip full Docusaurus pages — only process bare redirect stubs
                // generated by plugin-client-redirects (they never contain __docusaurus)
                if (html.includes('__docusaurus')) continue;
