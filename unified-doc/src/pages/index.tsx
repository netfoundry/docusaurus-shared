                ...
                <NetFoundryHorizontalSection >
                    <div className="container">
                        ...
                        <div className="buttons">
                            ...
                            <span style={{margin: '0 8px'}} />
                            <Link className="button button--secondary button--lg" to={useBaseUrl('/zlan/intro')}>zLAN Docs</Link>
                        </div>
                    </div>
                </NetFoundryHorizontalSection>
                        ...
                        <div className="row">
                            ...
                            <div className="col col--4">
                                <div className={styles.idxcard}>
                                    ...
                                    <div className="card__footer">
                                        <Link className="button button--primary button--block" to={useBaseUrl('/zlan/intro')}>Go to zLAN</Link>
                                    </div>
                                </div>
                            </div>
                            <div className="col col--4">
                                <div className={styles.idxcard}>
                                    ...
                                    <div className="card__footer">
                                        <Link className="button button--primary button--block" to={useBaseUrl('/zrok/getting-started')}>Go to zrok</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className={styles.idxcard}>
                                    ...
                                    <div className="card__body">
                                        <ul>
                                            ...
                                            <li><Link to={useBaseUrl('/zlan/intro')}>zLAN FAQ</Link></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
