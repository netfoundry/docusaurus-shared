...
export default function GitHubIcon({width = 22, height = 22, className, colored = false}: Props) {
  if (colored) {
    return (
      <svg width="100%" height="100%" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" className={className}>
        <path d={CAT} fill="white"/>
      </svg>
    );
  }
  return (
    <svg width="100%" height="100%" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className={className}>
      <path d={CAT}/>
    </svg>
  );
}
